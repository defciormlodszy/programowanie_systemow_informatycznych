#' ---
#' title: "Klastrowanie teskty nr 3"
#' author: "Autor: Szymon Dabrowski"
#' date: "`r Sys.Date()`"
#' output:
#'   html_document:
#'     df_print: paged
...
#ODPOWIED? 1:
# S? tu teksty o tematyce politycznej (najprawdopodniej przem?wienia), oraz o tematyce biznesowej
#ODPOWIED? 2:
# W przypadku podzia?u na 4 klastry to. Klaster 1 i 2 zawiera dokumenty o tematyce biznesowej. Za to klaster 3 i 4 zawieraj? teksty o temtyce politycznej.
# Klaster 3 zawiera tekst, kt?ry jest outlierem tematycznym. Wi?c mo?na podzieli? te teksty na dwie g?owne obszary tematyczne. I jeden outlaier.
